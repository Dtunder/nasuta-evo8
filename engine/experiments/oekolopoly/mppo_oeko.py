...
if __name__ == '__main__':
    sweep_id = wb.sweep(experiment_sweep_config, project="gymcts-oeko_core", entity="querry")
    print(sweep_id)
    #sweep_id = "es1qfpla"
    #wb.agent(sweep_id, function=perform_run, count=1, project="gymcts-oeko_core", entity="querry")
